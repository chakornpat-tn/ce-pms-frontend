...
function PreProject({}: Props) {
  ...
  const { data, isLoading, mutate } = useSWR(`committee-pre-project`, fetchData)
  ...
  const ProjectTable = ({
    ...
    return (
      <section className="relative mt-4 overflow-x-auto bg-gradient-to-b from-primary2-200 to-primary2-100 p-4 shadow-md sm:rounded-md">
        <article>
