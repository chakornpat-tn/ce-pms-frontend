  ...
  return (
    <div className='bg-bg_primary h-auto md:h-dvh flex justify-center items-start'>
      <div className='flex justify-center items-center flex-col md:mt-[5vh] bg-white w-4/5'>
        <div className='w-4/5'>
          <button className="bg-primary1 hover:bg-red-500 text-white py-0 px-3 rounded mb-4 mt-3">
        ...
        <div className='w-4/5 bg-white p-4 mt-5 text-center'>
          <button
            className="border border-primary1 hover:bg-green-500 text-primary1 py-2 px-40 rounded mb-2 mt-[-30px]"
          ...
          <button
            className="border border-primary1 hover:bg-green-500 text-primary1 py-2 px-40 rounded mb-2 mt-2"
